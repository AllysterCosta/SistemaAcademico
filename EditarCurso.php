        ...
        <div class="container">
            <div class="container-fluid row">
                <div class="col-10">
                    ...
                    <form method="post" action="editarCursoConnect.php" class="form-inline mt-3" id="formCadastroCursos">
                        <input type="hidden" name="id_curso" value="<?php print $row->id_curso; ?>">
                        <div class="row form-row align-items-center mb-4">
                            <label for="nome"></label>
                            <input type="text" id="nome" name="nome" class="form-control campos" placeholder="Nome do Curso" oninput="ValidandoNome()" value="<?php print $row->nome; ?>">
                        </div>
                        ...
                        <div class="row form-row aling-items-center mb-4">
                            <div class="from-group col-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="duracao" id="duracao" placeholder="Duração" class="form-control campos" value="<?php print $row->duracao; ?>">
